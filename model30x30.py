...
# This file is almost exactly same as "model.py", except it assumes that the
# input images are 30 by 30 pixels, so it adds one zero padding before the 
# second maxpooling operation.
